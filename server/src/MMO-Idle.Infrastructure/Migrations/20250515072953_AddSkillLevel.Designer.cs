...
namespace MMOIdle.Infrastructure.Migrations
{
    ...
    [Migration("20250515072953_AddSkillLevel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMO_Idle.Domain.Entities.CharacterBackpack", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MMO_Idle.Domain.Entities.CharacterEquipment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MMO_Idle.Domain.Entities.CharacterBackpack", b =>
                {
                    ...
                    b.HasOne("MMO_Idle.Domain.Entities.GameItem", "GameItem")
                        .WithMany()
            ...
            modelBuilder.Entity("MMO_Idle.Domain.Entities.CharacterEquipment", b =>
                {
                    ...
                    b.HasOne("MMO_Idle.Domain.Entities.GameItem", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
